...
// is confirmed identical to Enugu Air's (see UnitedConnector.ts), but the
...
// against a real United Nigeria search/booking run. Do not treat a
// successful type-check as evidence this works; it needs its own live
// verification pass (same kind of check done for Enugu Air) before use.
